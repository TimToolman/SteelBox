...
async function request<T>(path: string, options: RequestInit = {}): Promise<T> {
  ...
  try {
    ...
    throw new Error(deployedButLocal
      ? 'This site is not connected to a National SteelBox API server yet — please call us at (504) 555-0190.'
      : 'Could not reach the National SteelBox server. Check your connection and try again.')
  }
